        ...
        {woData.length > 0 && (
          <>
            <div className=" mx-5 sm:mx-0 my-3 ">
              {woData.map((item) => {
                return (
                  <div className="w-full rounded-[12px] border py-[16px] px-[24px] flex gap-[12px] text-[14px]">
                    <div className="w-full flex gap-[12px] flex-col">
                      <span>
                        APPROVAL DITJEN IMIGRASI (ALIH STATUS ITK - ITAS)
                        (SPONSOR PERUSAHAAN)
                      </span>
                      <Status title="Checking" bg_color="#D39E00" />
                      <div className="w-full border"></div>
                      <div className="w-full text-[#919CA7] font-[400]">
                        <table>
                          <tbody>
                            <tr className="flex gap-[12px]">
                              <td className="w-[160px]">Reference Number</td>
                              <td className="w-[4px]">:</td>
                              <td className="text-black">{item.ref_num}</td>
                            </tr>
                            <tr className="flex gap-[12px]">
                              <td className="w-[160px]">Name</td>
                              <td className="w-[4px]">:</td> <td></td>
                            </tr>
                            <tr className="flex gap-[12px]">
                              <td className="w-[160px]">Applicant</td>
                              <td className="w-[4px]">:</td> <td></td>
                            </tr>
                            <tr className="flex gap-[12px]">
                              <td className="w-[160px]">City / Country</td>
                              <td className="w-[4px]">:</td> <td></td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  {woData.map((item, index) => (
                    <React.Fragment key={index}>
                      ...
                      <tr>
                        ...
                        <td className="border px-4 py-2  w-2/3">{item.city}</td>
                      </tr>
                    </React.Fragment>
                  ))}
                </tbody>
